...
public class Ghost extends Enemy{
	...
	public Ghost(Point start, int time) {
		this.time = time;
		dead = false;
		xpos = start.x;
		ypos = start.y;
	...
	public void compileImages() {
		imgs = new Image[6];
		for(int i = 0; i<2; i++ ) {
			Image a = new ImageIcon("images/enemies/Ghost1.png").getImage();
			imgs[i] = a.getScaledInstance(45, 45, Image.SCALE_AREA_AVERAGING);
		}
		for(int i = 0; i<2; i++ ) {
			Image a = new ImageIcon("images/enemies/Ghost2.png").getImage();
			imgs[i+2] = a.getScaledInstance(45, 45, Image.SCALE_AREA_AVERAGING);
		}
		for(int i = 0; i<2; i++ ) {
			Image a = new ImageIcon("images/enemies/Ghost3.png").getImage();
			imgs[i+4] = a.getScaledInstance(45, 45, Image.SCALE_AREA_AVERAGING);
		}
	}
