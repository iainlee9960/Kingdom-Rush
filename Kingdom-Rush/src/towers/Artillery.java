...
public class Artillery extends Tower {
	...
	int y;
	Image[] imgs;
	public Artillery(int xpos, int ypos) {
	...
	public void compileImages() {
		Image b = new ImageIcon("images/towers/artillery.png").getImage();
		imgs[0] = b.getScaledInstance(125, 125, Image.SCALE_AREA_AVERAGING);
		Image a = new ImageIcon("images/towers/BigBertha.png").getImage();
